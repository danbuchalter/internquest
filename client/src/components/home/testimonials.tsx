  ...
  const testimonials = [
    {
      ...
      testimonial: "InternQuest helped me find an amazing marketing internship that perfectly matched my university studies. The application process was simple, and within two weeks I was starting my internship!"
    },
    {
      id: 2,
      name: "Sipho N.",
      ...
      testimonial: "As a self-taught programmer, I struggled to find opportunities. InternQuest connected me with a company that valued my skills over formal education. This internship launched my career!"
    },
    {
      id: 3,
      name: "Lerato K.",
      ...
      testimonial: "InternQuest has transformed our internship program. We've found exceptional talent that we might have missed through traditional recruitment. Many of our full-time hires started as interns from this platform."
    }
  ];
